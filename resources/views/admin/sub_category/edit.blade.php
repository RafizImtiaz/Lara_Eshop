    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="s{{ route('sub-categories.index') }}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="showHome" id="showHome" class="form-control" > 
                                <option {{ $subCategory->status == 'Yes' ? 'seletcted' : ''}} value="Yes" >Yes</option>
                                <option {{ $subCategory->status == 'No' ? 'seletcted' : ''}} value="No">No</option>      
                            </select>	
                        </div>
                    </div>										
                </div>
