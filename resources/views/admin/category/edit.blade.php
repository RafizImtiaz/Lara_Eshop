                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-control" > 
                                <option {{ $category->status == 1 ? 'seletcted' : ''}} value="1" >Active</option>
                                <option {{ $category->status == 0 ? 'seletcted' : ''}} value="0">Block</option>    
                            </select>	
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="showHome" id="showHome" class="form-control" > 
                                <option {{ $category->status == 'Yes' ? 'seletcted' : ''}} value="Yes" >Yes</option>
                                <option {{ $category->status == 'No' ? 'seletcted' : ''}} value="No">No</option>     
                            </select>	
                        </div>
                    </div>										
                </div>
